...
2. добавить обработчик даты для коммитов
...
5. при вводе текста в инпут текст должен быть более нассыщенным
6. добавить favicon
7. изменять title страницы в зависимости от содержания страницы
8. сделать ховер на название репа в списке или сделать ховер-тень на всю карточку? + курсор: поинтер
