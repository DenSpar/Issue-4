...
TODO:
3. можно прилипить верхнюю панель к верху экрана, а футер к низу
...
9. проверить, если какие-нибудь модули используются только в 1 месте, то перенести их из модулей в место использования
