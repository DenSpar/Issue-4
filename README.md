...
6. добавил favicon
7. title страницы изменяется в зависимости от содержания страницы

20.07.20
1. пришло письмо об уязвимости - устраняю

21.07.20
1. еще одно письмо, уже с коммитом для исправления - срезолвил, замержил
2. Заметил что после обновления lodash перестали выводиться языки на страницу репозитория. Возможно это не связанно с lodash, а изменилась документация, или все таки ранее пропущенная ошибка. Проблема была в условие, которое проверяло что вернулось с запроса языков. Предполагалось, что должен вернутся массив. Исправил
3. после обновления появилась ошибка "DevTools failed to load SourceMap". Установил source-map-loader
