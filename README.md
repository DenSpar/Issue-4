...
TODO:
4. при наведение на инпут, курсор должен меняться на курсор редакции текста
5. при вводе текста в инпут текст должен быть более насыщенным
6. сделать ховер на название репа в списке или сделать ховер-тень на всю карточку? + курсор: поинтер
