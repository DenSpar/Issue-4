...
13.07.20
1. переделал Promise.all на Promise.allSettled. Вместо ошибок от запроса последнего коммита должно выводить "-" в поле "last commit". К сожалению не смог проверить - не поймал подходящую ошибку
