...
2. реализовал отрисовку самых популярных репов из полученнго json. Здесь появилась следующая проблема - превышенно количество запросов к коммитам, git возвращает 403 ошибку